...
static const _Item_Request_type_support_symbol_names_t _Item_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_miner_interfaces, srv, Item_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_miner_interfaces, srv, Item_Request)),
  }
};
...
{
  return &::robo_miner_interfaces::srv::rosidl_typesupport_cpp::Item_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_miner_interfaces, srv, Item_Request)() {
  return get_message_type_support_handle<robo_miner_interfaces::srv::Item_Request>();
}
...
static const _Item_Response_type_support_symbol_names_t _Item_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_miner_interfaces, srv, Item_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_miner_interfaces, srv, Item_Response)),
  }
};
...
{
  return &::robo_miner_interfaces::srv::rosidl_typesupport_cpp::Item_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_miner_interfaces, srv, Item_Response)() {
  return get_message_type_support_handle<robo_miner_interfaces::srv::Item_Response>();
}
...
static const _Item_type_support_symbol_names_t _Item_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_miner_interfaces, srv, Item)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_miner_interfaces, srv, Item)),
  }
};
...
{
  return &::robo_miner_interfaces::srv::rosidl_typesupport_cpp::Item_service_type_support_handle;
}
